package com.gobeyond.firebase.util.service;
...
import com.gobeyond.firebase.config.FirebaseConfigurationPro;
import com.google.api.client.googleapis.auth.oauth2.GoogleCredential;
import com.google.auth.oauth2.GoogleCredentials;
import com.google.firebase.FirebaseApp;
import com.google.firebase.FirebaseOptions;

@EnableConfigurationProperties(FirebaseConfigurationPro.class)
public class FirebaseApplicationService {
	...
	private final FirebaseConfigurationPro firebaseConfigurationProperties;

	public FirebaseApplicationService(ResourceLoader resourceLoader,
			FirebaseConfigurationPro firebaseConfigurationProperties) throws IOException {
		...
		// file: or classpath:
		Resource serviceAccount = resourceLoader
				.getResource(firebaseConfigurationProperties.getServiceAccountFilename());
